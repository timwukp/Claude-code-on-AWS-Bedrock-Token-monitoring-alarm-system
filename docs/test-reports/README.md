...
| Cost page windowing (Cost follows the global time range; `/v1/overview.byModel.cacheSavingsUsd`; Budget-tile source note; one Anomalies control) | — | TBD | [feature-27](./feature-27-cost-windowing.md) | PASS (gates + local render) |
