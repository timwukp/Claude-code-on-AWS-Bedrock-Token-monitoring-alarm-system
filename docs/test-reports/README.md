...
| ROI model diagram layout (footnotes no longer under the result box; owner-reported) | — | TBD | [feature-19b](./feature-19b-roi-diagram-layout.md) | PASS (gates + local render) |
