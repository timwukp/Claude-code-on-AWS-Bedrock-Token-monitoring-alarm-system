...
`Accepted-for` is the tip of `main` after PR #49, the merge base at branch time. Numbered 23 because
...
Non-source riders: `.sdlc/active` (handover from `projects-roi-followups`), `intent/projects-roi-followups/*` →
shipped (my own predecessor), `intent/overview-page/*`, `CHANGELOG.md`,
